    ...
    <div class="mx-auto max-w-7xl flex h-16 items-center justify-between px-4">
        ...
        <div class="flex gap-4">
            ...
            <a href="/referencias" class="<?= $_SERVER['REQUEST_URI'] === '/referencias' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Referencias</a>
